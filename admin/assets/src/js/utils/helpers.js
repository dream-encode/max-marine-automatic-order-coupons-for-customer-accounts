...
export const convertTimestampToFriendlyDate = ( timestamp ) => {
	if ( ! timestamp ) {
		return __( 'N/A', 'max-marine-automatic-order-coupons-for-customer-accounts' )
	}
...
export const wpEditPostLinkFromPostId = ( postID ) => {
	return addQueryArgs( `${ MMAOCFCA.ADMIN_URL }post.php`, { post: postID, action: 'edit' } )
}