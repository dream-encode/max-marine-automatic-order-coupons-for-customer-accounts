 ...
 *
 * @since      1.0.0
 * @package    Max_Marine\Automatic_Order_Coupons_For_Customer_Accounts
 * @subpackage Max_Marine\Automatic_Order_Coupons_For_Customer_Accounts/admin
 * @author     David Baumwald <david@dream-encode.com>
 */

namespace Max_Marine\Automatic_Order_Coupons_For_Customer_Accounts\Core\ListTable;
 ...
 * @author     David Baumwald <david@dream-encode.com>
 */
class Max_Marine_Automatic_Order_Coupons_For_Customer_Accounts_List_Table extends WP_List_Table {
	...
	public function __construct() {
		parent::__construct(
			array(
				'singular' => __( 'Thing', 'max-marine-automatic-order-coupons-for-customer-accounts' ),
				'plural'   => __( 'Things', 'max-marine-automatic-order-coupons-for-customer-accounts' ),
				'ajax'     => false,
			)
		);
	}
	...
	public function no_items() {
		esc_html_e( 'No things.', 'max-marine-automatic-order-coupons-for-customer-accounts' );
	}
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			case 'timestamp':
				...
				if ( ! $date ) {
					$date = __( 'N/A', 'max-marine-automatic-order-coupons-for-customer-accounts' );
				}
	...
	public function get_columns() { // @phpcs:ignore @phpstan-ignore-line
		$columns = array(
			'timestamp' => __( 'Date', 'max-marine-automatic-order-coupons-for-customer-accounts' ),
			'id'        => __( 'ID', 'max-marine-automatic-order-coupons-for-customer-accounts' ),
		);
