<?php
/**
 * Class Max_Marine_Automatic_Order_Coupons_For_Customer_Accounts_REST_Authentication.
 *
 * @since 1.0.0
 */
...
return new Max_Marine_Automatic_Order_Coupons_For_Customer_Accounts_REST_Authentication();
